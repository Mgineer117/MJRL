...
from gridworld.core.agent import Agent, AgentT, CtFActions, GridActions, PolicyAgent
...
class CtfMvNEnv(MultiGridEnv):
    ...
    def __init__(
        ...
        max_steps: int = 200,
        observation_option: ObservationOption = "flattened",
    ...
    def step(
        ...
        blue_agent_locs_np: NDArray[np.float32] = np.array(blue_agent_locs)
        red_agent_locs_np: NDArray[np.float32] = np.array(red_agent_locs)
...
class CtF(CtfMvNEnv):
    ...
    def __init__(
        ...
        enemy_policy_kwarg: dict[str, Any] = {"action_set": GridActions},
        battle_range: float = 1,
