...
from gridworld.core.agent import ActionsT, AgentT, DefaultActions
from gridworld.core.constants import *
from gridworld.core.grid import Grid
from gridworld.core.object import WorldObjT
from gridworld.core.world import DefaultWorld, WorldT
...
class MultiGridEnv(gym.Env):
    ...
    ) -> tuple[NDArray[np.int_], NDArray[np.float32], bool, bool, dict]:
        self.step_count += 1
